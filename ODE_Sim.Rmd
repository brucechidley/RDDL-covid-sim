...
parms  = c(beta=0.2075, kappa=1/9, alpha=1/16, N=100, rec=1/14)
start = c(S=88, E=0, I=12, R = 0)
```
...
```{r}
plot(x = out$time, y = out$S, col = "green", ylab = "Number of individuals", 
      xlab = "Time (days)", type = "l", xlim = c(0, 200), ylim = c(0,100))
